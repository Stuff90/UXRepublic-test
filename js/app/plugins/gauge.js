	...
	$.fn.gauge = function(){
		...
		var gauge = this,
	 	...
	 	gauge.drawFullCirle = function(aGauge) {
			...
			aGauge.lineWidth = 20;
			aGauge.arc(W/2, H/2, 50, 0, Math.PI*2, false);
			aGauge.stroke();
		};
	 	...
	 	gauge.drawPercentValue = function(aGauge , arcEndValue , text) {
			...
			aGauge.font = "36px 'Arial Black'";
			aGauge.fillText(text, W / 2 - text_width * 1.8 , H / 2 + 10);

			aGauge.strokeStyle = aGauge.arcColor;
			aGauge.fillStyle = aGauge.arcColor;
			aGauge.font = "13px 'Arial Black'";
			aGauge.fillText('%', W / 2 + text_width , H / 2 + 10);
	 	...
	 	gauge.drawArc = function(aGauge , arcEndValue , text) {
			...
			aGauge.strokeStyle = aGauge.arcColor;
			aGauge.lineWidth = 20;
			aGauge.arc( W / 2 , H / 2, 50 , 0 - 90 * Math.PI / 180 , arcEndValue - 90 * Math.PI / 180, false);
			aGauge.stroke();
