!function(a, b) {
    ...
    function k(a) {
        ...
        this._months = +e + 3 * d + 12 * c, this._data = {}, this._locale = rb.localeData(), 
        this._bubble();
    }
    function l(a, b) {
    ...
    function m(a, b) {
        ...
        "undefined" != typeof b._locale && (a._locale = b._locale), Fb.length > 0) for (c in Fb) d = Fb[c], 
    ...
    function q(a, b) {
        var c;
        return b = J(b, a), a.isBefore(b) ? c = p(a, b) : (c = p(b, a), c.milliseconds = -c.milliseconds, 
        c.months = -c.months), c;
    }
    function r(a, b) {
        return function(c, d) {
            ...
            g = c, c = d, d = g), c = "string" == typeof c ? +c : c, e = rb.duration(c, d), 
            s(this, e, a), this;
        };
    }
    function s(a, b, c, d) {
        var e = b._milliseconds, f = b._days, g = b._months;
        d = null == d ? !0 : d, e && a._d.setTime(+a._d + e * c), f && lb(a, "Date", kb(a, "Date") + f * c), 
        g && jb(a, kb(a, "Month") + g * c), d && rb.updateOffset(a, f || g);
    }
    function t(a) {
    ...
    function E(a) {
        ...
        a._pf._overflowDayOfYear && (xb > b || b > zb) && (b = zb), a._pf.overflow = b);
    }
    function F(a) {
    ...
    function N(a, b) {
        ...
        var d = 5;
        for (Lb.lastIndex = 0; d >= 0 && Lb.test(a); ) a = a.replace(Lb, c), Lb.lastIndex = 0, 
        d -= 1;
        return a;
    }
    function O(a, b) {
    ...
    function R(a) {
        var c, d, e, f, g, h, i;
        c = a._w, null != c.GG || null != c.W || null != c.E ? (g = 1, h = 4, d = b(c.GG, a._a[xb], fb(rb(), 1, 4).year), 
        e = b(c.W, 1), f = b(c.E, 1)) : (g = a._locale._week.dow, h = a._locale._week.doy, 
        d = b(c.gg, a._a[xb], fb(rb(), g, h).year), e = b(c.w, 1), null != c.d ? (f = c.d, 
        g > f && ++e) : f = null != c.e ? c.e + g : g), i = gb(d, e, f, h, g), a._a[xb] = i.year, 
        a._dayOfYear = i.dayOfYear;
    }
    function S(a) {
        var c, d, e, f, g = [];
        if (!a._d) {
            for (e = U(a), a._w && null == a._a[zb] && null == a._a[yb] && R(a), a._dayOfYear && (f = b(a._a[xb], e[xb]), 
            a._dayOfYear > C(f) && (a._pf._overflowDayOfYear = !0), d = bb(f, 0, a._dayOfYear), 
            a._a[yb] = d.getUTCMonth(), a._a[zb] = d.getUTCDate()), c = 0; 3 > c && null == a._a[c]; ++c) a._a[c] = g[c] = e[c];
    ...
    function T(a) {
        var b;
        a._d || (b = x(a._i), a._a = [ b.year, b.month, b.day, b.hour, b.minute, b.second, b.millisecond ], 
        S(a));
    }
    function U(a) {
        var b = new Date();
    ...
    function V(a) {
        ...
        for (d = N(a._f, a._locale).match(Kb) || [], b = 0; b < d.length; b++) e = d[b], 
        c = (g.match(O(e, a)) || [])[0], c && (f = g.substr(0, g.indexOf(c)), f.length > 0 && a._pf.unusedInput.push(f), 
        g = g.slice(g.indexOf(c) + c.length), i += c.length), mc[e] ? (c ? a._pf.empty = !1 : a._pf.unusedTokens.push(e), 
        Q(e, c, a)) : a._strict && !c && a._pf.unusedTokens.push(e);
        a._pf.charsLeftOver = h - i, g.length > 0 && a._pf.unusedInput.push(g), a._isPm && a._a[Ab] < 12 && (a._a[Ab] += 12), 
    ...
    function Y(a) {
        ...
        for (f = 0; f < a._f.length; f++) g = 0, b = m({}, a), b._pf = c(), b._f = a._f[f], 
        V(b), F(b) && (g += b._pf.charsLeftOver, g += 10 * b._pf.unusedTokens.length, b._pf.score = g, 
        (null == e || e > g) && (e = g, d = b));
        l(a, d || b);
    }
    function Z(a) {
    ...
    function hb(b) {
        ...
        return b._locale = b._locale || rb.localeData(b._l), null === c || d === a && "" === c ? rb.invalid({
            nullInput: !0
        }) : ("string" == typeof c && (b._i = c = b._locale.preparse(c)), rb.isMoment(c) ? new j(c, !0) : (d ? t(d) ? Y(b) : V(b) : _(b), 
        new j(b)));
    }
    function ib(a, b) {
        var c, d;
    ...
    function jb(a, b) {
        var c;
        return "string" == typeof b && (b = a.localeData().monthsParse(b), "number" != typeof b) ? a : (c = Math.min(a.date(), A(a.year(), b)), 
    ...
    }, nc = {}, oc = [ "months", "monthsShort", "weekdays", "weekdaysShort", "weekdaysMin" ]; kc.length; ) tb = kc.pop(), 
    mc[tb + "o"] = h(mc[tb], tb);
    ...
    mc.DDDD = g(mc.DDD, 3), l(i.prototype, {
        ...
        monthsParse: function(a) {
            var b, c, d;
            for (this._monthsParse || (this._monthsParse = []), b = 0; 12 > b; b++) if (this._monthsParse[b] || (c = rb.utc([ 2e3, b ]), 
        ...
        weekdaysParse: function(a) {
            var b, c, d;
            for (this._weekdaysParse || (this._weekdaysParse = []), b = 0; 7 > b; b++) if (this._weekdaysParse[b] || (c = rb([ 2e3, 1 ]).day(b), 
        ...
        g._i = b, g._f = d, g._l = e, g._strict = f, g._isUTC = !1, g._pf = c(), hb(g);
        ...
        return rb.isDuration(a) ? g = {
            ...
            d: a._days,
            M: a._months
        } : "number" == typeof a ? (g = {}, b ? g[b] = a : g.milliseconds = a) : (h = Ib.exec(a)) ? (c = "-" === h[1] ? -1 : 1, 
        g = {
            y: 0,
            d: z(h[zb]) * c,
            h: z(h[Ab]) * c,
        ...
        g = {}, g.ms = f.milliseconds, g.M = f.months), d = new k(g), rb.isDuration(a) && a.hasOwnProperty("_locale") && (d._locale = a._locale), 
        d;
    }, rb.version = ub, rb.defaultFormat = bc, rb.ISO_8601 = function() {}, rb.momentProperties = Fb, 
    rb.updateOffset = function() {}, rb.relativeTimeThreshold = function(b, c) {
        ...
        c && (rb.duration._locale = rb._locale = c)), rb._locale._abbr;
    }, rb.defineLocale = function(a, b) {
        return null !== b ? (b.abbr = a, Eb[a] || (Eb[a] = new i()), Eb[a].set(b), rb.locale(a), 
        Eb[a]) : (delete Eb[a], null);
    ...
    rb.normalizeUnits = function(a) {
        ...
        diff: function(a, b, c) {
            ...
            return b = w(b), "year" === b || "month" === b ? (d = 432e5 * (this.daysInMonth() + f.daysInMonth()), 
            e = 12 * (this.year() - f.year()) + (this.month() - f.month()), e += (this - rb(this).startOf("month") - (f - rb(f).startOf("month"))) / d, 
        ...
        zone: function(a, b) {
            ...
            Math.abs(a) < 16 && (a = 60 * a), !this._isUTC && b && (c = this._d.getTimezoneOffset()), 
            this._offset = a, this._isUTC = !0, null != c && this.subtract(c, "m"), d !== a && (!b || this._changeInProgress ? s(this, rb.duration(d - a, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0, 
            rb.updateOffset(this, !0), this._changeInProgress = null)), this);
        },
        zoneAbbr: function() {
    ...
    }), rb.fn.millisecond = rb.fn.milliseconds = mb("Milliseconds", !1), rb.fn.second = rb.fn.seconds = mb("Seconds", !1), 
    rb.fn.minute = rb.fn.minutes = mb("Minutes", !1), rb.fn.hour = rb.fn.hours = mb("Hours", !0), 
    rb.fn.date = mb("Date", !0), rb.fn.dates = e("dates accessor is deprecated. Use date instead.", mb("Date", !0)), 
    rb.fn.year = mb("FullYear", !0), rb.fn.years = e("years accessor is deprecated. Use year instead.", mb("FullYear", !0)), 
    rb.fn.days = rb.fn.day, rb.fn.months = rb.fn.month, rb.fn.weeks = rb.fn.week, rb.fn.isoWeeks = rb.fn.isoWeek, 
    rb.fn.quarters = rb.fn.quarter, rb.fn.toJSON = rb.fn.toISOString, l(rb.duration.fn = k.prototype, {
        _bubble: function() {
            var a, b, c, d = this._milliseconds, e = this._days, f = this._months, g = this._data, h = 0;
            g.milliseconds = d % 1e3, a = n(d / 1e3), g.seconds = a % 60, b = n(a / 60), g.minutes = b % 60, 
            c = n(b / 60), g.hours = c % 24, e += n(c / 24), h = n(nb(e)), e -= n(ob(h)), f += n(e / 30), 
            e %= 30, h += n(f / 12), f %= 12, g.days = e, g.months = f, g.years = h;
        },
        abs: function() {
        ...
        as: function(a) {
            var b, c;
            if (a = w(a), b = this._days + this._milliseconds / 864e5, "month" === a || "year" === a) return c = this._months + 12 * nb(b), 
            "month" === a ? c : c / 12;
...
}.call(this), $.fn.calendar = function() {
    var calendar = this;
    return calendar.M = new moment(), calendar.updateMonth = function(e) {
        e.preventDefault();
        var $trigger = $(e.target);
        0 !== $trigger.parent(".next").length && console.log("var1, var2");
    }, calendar.updateYear = function(e) {
        e.preventDefault();
        var $trigger = $(e.target);
        0 !== $trigger.parent(".next").length && console.log("var1, var2");
    }, calendar.buildLayout = function(i, root) {
        calendar.$root = $(root);
        var header = $("<div>").addClass("ui-cal-header").append($("<p>").append($("<span>").text(calendar.M.format("MMMM")), $("<span>").text(calendar.M.format("YYYY")))), controls = $("<div>").addClass("ui-cal-controls").append($("<ul>").addClass("next").append($("<li>").text("<<").on("click", calendar.updateYear), $("<li>").text("<").on("click", calendar.updateMonth))).append($("<ul>").addClass("previous").append($("<li>").text("<").on("click", calendar.updateMonth), $("<li>").text("<<").on("click", calendar.updateYear))), month = $("<div>").addClass("ui-cal-month").append($("<ul>").append(function() {
            for (var week = [ "m", "t", "w", "t", "f", "s", "s" ], elts = [], i = 0; i < week.length; i++) elts.push($("<li>").text(week[i]));
            return elts;
        })).append($("<ul>").append(function() {
            for (var elts = [], i = 0; 42 > i; i++) elts.push($("<li>"));
            return elts;
        }));
        calendar.$root.addClass("ui-cal").append(header, controls, month);
    }, console.log(calendar.M.format("dd")), console.log(calendar.M.add(5, "days").format("dd")), 
    this.each(calendar.buildLayout);
}, $.fn.gauge = function() {};

var $doc = $(document);

$doc.ready(function() {
    console.info("Page is ready !"), $doc.find(".calendar").calendar();
});